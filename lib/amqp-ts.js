...
var Message = /** @class */ (function () {
    ...
    Message.prototype.sendTo = function (destination, routingKey) {
        ...
        var sendMessage = function (callback) {
            try {
                destination._channel.publish(exchange, routingKey, _this.content, _this.properties, callback);
            }
            catch (err) {
        ...
        if (destination._options.confirms) {
            var promise = new Promise(function (resolve, reject) {
                sendMessage(function (err, ok) {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    Exchange.prototype._initialize = function () {
        ...
        this.initialized = new Promise(function (resolve, reject) {
            _this._connection.initialized.then(function () {
                _this._connection._connection[_this._options.confirms ? "createConfirmChannel" : "createChannel"](function (err, channel) {
                    /* istanbul ignore if */
                    if (err) {
                        reject(err);
                    }
